...
function CreateListing() {
  ...
  const onSubmit = async (e) => {
    ...
    if (geolocationEnabled) {
      const response = await fetch(
        `https://maps.googleapis.com/maps/api/geocode/json?address=${address}&key=AIzaSyCp6XbZDCFc4L03Xj_9wh4f5jGuCGq5fvI`
      );
  ...
  const onMutate = (e) => {
    //for boolean the value is coming as string so we are converting it to boolean
    let boolean = null;
